...
public class RandMemiActivity extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel RandMem Benchmark 1.2 ";
    ...
    static 
    {
        System.loadLibrary("randmemilib");
    }
 ...
 */
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel RandMem Benchmark Results");
    ...
    public void clear()
    {
        ...
        xout[14] = "\n";
        xout[15] = "\n";
        xout[16] = "    Likely running time 10 to 50 seconds\n"; 
        testDone = 0;       
    }
