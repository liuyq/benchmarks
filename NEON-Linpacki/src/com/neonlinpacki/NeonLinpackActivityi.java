...
public class NeonLinpackActivityi extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel NEON Linpack Benchmark V 1.2 ";
    ...
    static 
    {
        System.loadLibrary("linpackneonilib");
    }
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                    mDisplayDetails.setText(
                          ...
                          " uses special NEON intrinsic functions. These operate \n" +
                          " on single precision numbers on a Single Instruction \n" +
                          " Multiple Data (SIMD) basis using 128 bit registers.\n" +
                          " \n" +
                          " Roy Longbottom 2013\n");                  
                          resetTest();
                          testDone = 0;
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel NEON Linpack Benchmark Results");
