...
public class BusSpdActivityi extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel MP-BusSpd Benchmark V1.2 ";
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-BusSpd Benchmark Results");
