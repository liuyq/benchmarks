...
public class MainActivityi extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel MP-MFLOPS v7 Benchmark V1.2 ";
    ...
    static 
    {
        System.loadLibrary("mpmflopsilib");
    }
    ...
    protected Dialog onCreateDialog(int id) 
    {
        switch (id) 
        {
          case 8:
            ...
            builder.setNegativeButton("MP-MFLOPS Details", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which)
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-MFLOPS Benchmark Results");
    ...
    public void clear()
    {
        ...
        xout[8]  = " 4T\n";
        xout[9]  = " 8T\n ";
        xout[10] = " Results x 100000, 0 indicates ERRORS\n";
        xout[11] = " 1T\n";
        xout[12] = " 2T\n";
        xout[13] = " 4T\n";
        xout[14] = " 8T\n";
        xout[15] = "\n";
        xout[16] = " Run time about 10 seconds dual core fast FPU ARMv7\n"; 
        testDone = 0;       
    }
