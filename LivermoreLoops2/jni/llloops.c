/************************************************************************
 *                                                                      *
 *     ~/workspace/LivermoreLoops/jni$ ~/Eclipse/android-ndk-r7/ndk-build
 *
 *    Changes made to init() function to allow compilation - see below
 *                                                                      *
...
jstring
Java_com_loops2_LivermoreLoops2Activity_stringFromJNI( JNIEnv* env, jobject thiz)
{
...
*/            
    ...
    sprintf(resultchars,
            ...
            "  %22.15e %22.15e\n",
            Mflops[0][ 1], Mflops[0][ 2], Mflops[0][ 3], Mflops[0][ 4], Mflops[0][ 5], Mflops[0][ 6], 
            Mflops[0][ 7], Mflops[0][ 8], Mflops[0][ 9], Mflops[0][10], Mflops[0][11], Mflops[0][12],
            Mflops[0][13], Mflops[0][14], Mflops[0][15], Mflops[0][16], Mflops[0][17], Mflops[0][18], 
            Mflops[0][19], Mflops[0][20], Mflops[0][21], Mflops[0][22], Mflops[0][23], Mflops[0][24], 
            maximum[3], average[3], geometric[3], harmonic[3], minimum[3],
            Checksum[2][23], Checksum[2][24]);
