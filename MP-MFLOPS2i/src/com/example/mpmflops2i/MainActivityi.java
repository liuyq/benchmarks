package com.example.mpmflops2i;
...
{
    private String version = " ARM/Intel MP-MFLOPS2 Benchmark V2.2 ";
    ...
    static 
    {
        System.loadLibrary("mpmflops2ilib");
    }
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-MFLOPS2 Benchmark Results");
    ...
    public void clear()
    {
        ...
        xout[14] = " 8T\n";
        xout[15] = "\n";
        xout[16] = " Run time 50 to 100+ seconds on dual core CPUs\n"; 
        testDone = 0;       
    }
