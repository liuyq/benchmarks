package com.example.dhrystonei;
...
public class DhryActivityi extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel MP-Dhrystone 2 Benchmark V1.2 ";
          ...
          case 8:
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                  ...
                  " This version runs one copy then multiple copies in 2, 4 \n" +
                  " and 8 threads with the code compiled by Android Native\n" +
                  " Kit. \n" +
                  " \n" +  
                  " \n" +
                  " Roy Longbottom 2013\n");
            ...
            builder.setNegativeButton("MP-Dhry Details", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which)
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-Dhrytone 2 Benchmark Results");
    ...
    public void clear()
    {
        ...
        xout[4]  = " Threads\n";
        xout[5]  = " Seconds\n";
        xout[6]  = " Dhrystones per Second\n";
        xout[7]  = " VAX MIPS rating\n";
        xout[8]  = "\n";
        xout[9]  = "\n ";
        xout[10] = "\n";
        xout[11] = " Check same internal pass count all threads \n";
        xout[12] = "\n";
        xout[13] = "\n";
        xout[14] = "\n";
        xout[15] = "\n";
        xout[16] = " Run time estimate 10 seconds or less\n"; 
        testDone = 0;       
    }
