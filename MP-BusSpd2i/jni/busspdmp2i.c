...
jstring Java_com_bus2i_BusSpdActivity2i_stringFromJNI( JNIEnv* env, jobject thiz, jint ipass)
{
    int     wds;
    int     i, s, t, w;
    int     mbpersec;
