/*
  ~/workspace/NeonSpeed/jni$ ~/Eclipse/android-ndk-r7/ndk-build
*/
...
void intvplusv(uint32_t *x, uint32_t *y, int size)
{
 ...
 jstring
 Java_com_neonspeedi_NeonSpeedActivityi_stringFromJNI( JNIEnv* env, jobject thiz, jint size)
{
    uint64_t features;
...
//                          mem, res1, res2, res3, res4, res5, res6, msg);
