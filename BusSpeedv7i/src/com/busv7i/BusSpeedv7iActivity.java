...
public class BusSpeedv7iActivity extends Activity  implements View.OnClickListener
{
    private String version = " ARM/Intel BusSpeed Benchmark 1.2 ";
    ...
    static 
    {
        System.loadLibrary("busspeedv7ilib");
    }
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                    mDisplayDetails.setText(
                        ...
                        " be estimated by multiplying this minimum value by 8.  \n" +
                        " With this burst rate, measured speed at 32 word and 16\n" +
                        " word increments are likely to be the same. Cache sizes\n" +
                        " are indicated by varying speed as memory use changes. \n" +
                        " Note, with smallest L1 cache demands, measured speed \n" +
                        " can be low due to overheads when reading little data.\n" +
                        " \n" +
                        " Roy Longbottom 2013\n");
                    resetTest();
                    testDone = 0;
 ...
 */
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel BusSpeed v7 Benchmark Results");
    ...
    public void clear()
    {
        xout[0]  = version + date$ + "\n" + stringFromJNI2();
        xout[1]  = "\n";
        xout[2]  = "    Reading Speed 4 Byte Words in MBytes/Second\n";
        xout[3]  = "  Memory  Inc32  Inc16   Inc8   Inc4   Inc2   Read\n";
        xout[4]  = "  KBytes  Words  Words  Words  Words  Words    All\n";
        xout[5]  = "\n";
        xout[6]  = "\n";
        xout[7]  = "\n";
        xout[8]  = "\n";
        ...
        xout[14] = "\n";
        xout[15] = "\n";
        xout[16] = "    Likely running time 5 to 15 seconds\n"; 
        testDone = 0;       
    }
