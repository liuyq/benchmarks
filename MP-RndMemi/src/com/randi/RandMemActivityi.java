...
public class RandMemActivityi extends Activity implements View.OnClickListener
{
    private String version = " ARM/Intel MP-RndMem Benchmark V1.2 ";
          ...
          case 8:
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                  ...
                  " RandMem benchmark carries out four tests at increasing \n" + 
                  " data sizes to produce data transfer speeds in MBytes   \n" + 
                  " Per Second from caches and memory. Serial and random   \n" + 
                  " address selections are employed, using the same program \n" + 
                  " structure, with read and read/write tests using 32 bit \n" + 
                  " integers. The main purpose is to demonstrate how much  \n" + 
                  " slower performance can be through using random access. \n" +                     
                  " Here, speed can be considerably influenced by reading  \n" +
                  " and writing in bursts, where much of the data is not   \n" +
                  " used, and by the size of preceding caches.             \n" +
                  " The multithreading version runs via 1, 2, 4 & 8 threads \n" +
                  " using the same data array but starting at different    \n" +
                  " address points. A check is carried out that each thread \n" +
                  " produces the same result, for serial reading, and a    \n" +
                  " message displayed if they are not equal.               \n" +
                  " \n" +                                       
                  " Roy Longbottom 2013\n");
                    resetTest();
                    testDone = 0;
            ...
            builder.setNegativeButton("MP-RandMem Details", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which)
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-RndMem Benchmark Results");
    ...
    public void clear()
    {
        xout[0]  = version + date$ + "\n" + stringFromJNI2();
        xout[1]  = "\n";
        xout[2]  = "  MB/Second Using 1, 2, 4 and 8 Threads\n";
        xout[3]  = "  KB       SerRD SerRDWR   RndRD RndRDWR\n";
        xout[4]  = "12.29 1T\n";
        xout[5]  = "      2T\n";
        xout[6]  = "      4T\n";
        xout[7]  = "      8T\n";
        ...
        xout[14] = "      4T\n";
        xout[15] = "      8T\n";
        xout[16] = "\n  Run time estimate 40 to 50 seconds"; 
        testDone = 0;       
    }
