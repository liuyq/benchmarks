...
public class JavaOpenGL1Activity extends Activity implements View.OnClickListener
{
          ...
          case 8:
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                        ...
                        (
                          " JavaOpenGL1 uses all Java code with OpenGL to measure   \n" + 
                          " graphics performance in Frames Per Second (FPS). Four   \n" + 
                          " tests draw a background of 50 cubes first as wireframes \n" + 
                          " then colour shaded. The third test views the cubes in   \n" + 
                          " and out of a tunnel with slotted sides and roof, also   \n" + 
                          " containing rotating plates. The last test adds textures \n" + 
                          " to the cubes and plates. The 50 cubes are redrawn 15,   \n" +                     
                          " 30 and 60 times, with randomised positions, colours and \n" +
                          " rotational settings. With 6 x 2 triangles per cube,     \n" +
                          " minimum triangles per frame for the three sets of tests \n" +
                          " are 9000, 18000 and 36000.                              \n" +
                          " \n" +
                          " \n" +
                          " \n" +
                          " \n" +
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Android Java OpenGL Benchmark Results");
...
{ 
    ...
    public void clear()
    {
        ...
        xout[3]  = " Triangles WireFrame   Shaded  Shaded+ Textured\n";
        xout[4]  = "\n";
        xout[5]  = "   9000\n";
        xout[6]  = "  18000+\n";
        xout[7]  = "  36000+\n";
        xout[8]  = "\n";
        xout[9]  = " The four tests draw 50 cubes repeated with randomised  \n";
        xout[10] = " positions, colours and rotational settings that produce\n";
        xout[11] = " the above triangles per frame. They are as wireframes, \n";
        xout[12] = " colour shaded and textures. Third and fourth tests move\n";
        xout[13] = " in and out of a tunnel with slotted sides and roof.    \n";
        xout[14] = "\n";
        xout[15] = " Expected running time 10+ seconds for each of 12 tests\n";
        xout[16] = "\n";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(resultCode == 1)
        {
            ...
            xout[9]  = "";
            xout[10] = "\n";
            xout[11] = "      Total Elapsed Time  " + String.format("%5.1f", testTime) + " seconds\n";
            xout[12] = "\n";
            xout[13] = "\n";
            xout[14] = "\n";
            xout[15] = "\n";
