...
public class WhetsActivityi extends Activity implements View.OnClickListener
{
    private String version = "    ARM/Intel MP-Whetstone Benchmark V1.2 ";
    ...
    static 
    {
        System.loadLibrary("mpwhetsilib");
    }
          ...
          case 8:
            ...
            builder.setPositiveButton("About Summary", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which) 
                {
                      ...
                      " The Whetstone Benchmark was the first accepted program \n" + 
                      " that set industry standards of computer performance.   \n" + 
                      " It was released  in 1972. Speed was measured in terms  \n" + 
                      " of Million Whetstone Instructions Per Second (MWIPS).  \n" + 
                      " Later, in order to identify compiler over-optimisation,\n" + 
                      " speeds of individual tests were shown as MOPS or MFLOPS \n" + 
                      " - Millions of Operations or Floating Point Operations  \n" +                     
                      " Per Second. This version uses the same programming code \n" +
                      " as my Linux Multithreading Whetstone Benchmark, except \n" +
                      " the tests are run using 1, 2, 4 and 8 threads, executed \n" +
                      " from common code, total MOPS and MFLOPS being displayed. \n" +
                      " The program checks for consistent numeric results. Use \n" +
                      " other Info buttons to see sample results, details and  \n" +
                      " links for my other benchmarks, lots of them variations \n" +
                      " of Whetstone Benchmarks and results from 1960s CPUs on.\n" +   
                      " \n" +
                      " Roy Longbottom 2013\n");
                        resetTest();
                        testDone = 0;
            ...
            builder.setNegativeButton("MP-WHETS Details", new DialogInterface.OnClickListener() 
            {
                public void onClick(DialogInterface dialog, int which)
              ...
              builder2.setNegativeButton("OK", new DialogInterface.OnClickListener() 
              {
                  public void onClick(DialogInterface dialog, int which) 
                  {
                    Editable value = input.getText();
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "ARM/Intel MP-Whetstone Benchmark Results");
    ...
    public void clear()
    {
        xout[0]  = version + date$ + "\n" + stringFromJNI2();
        xout[1]  = "\n";
        xout[2]  = "                   Using 1, 2, 4 and 8 Threads\n";
        xout[3]  = "     MWIPS MFLOPS MFLOPS MFLOPS   Cos   Exp   Fixpt      If  Equal\n";
        xout[4]  = "                1      2      3  MOPS  MOPS    MOPS    MOPS   MOPS\n";
        xout[5]  = "\n";
        xout[6]  = "1T\n";
        xout[7]  = "2T\n";
        xout[8]  = "4T\n";
        xout[9]  = "8T\n ";
        xout[10] = "\n";
        xout[11] = " Overall Seconds\n";
        xout[12] = "\n";
        xout[13] = " Numeric results correct?\n";
        xout[14] = "\n";
        xout[15] = "\n";
        xout[16] = " Run time estimate 60 seconds or less\n"; 
        testDone = 0;       
    }
